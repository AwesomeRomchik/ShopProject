...
if (session_status() == PHP_SESSION_NONE) {
 ...
 $q = "SELECT * FROM shop WHERE gender='kids'" ;
 if(isset($_POST['colour'])){
     if($_POST['colour'] == 'black'){
         //Run query
         $q = "SELECT * FROM shop WHERE colour = 'black' AND gender='kids'";
     }elseif($_POST['colour'] == 'beige'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'beige' AND gender='kids'";
     }elseif($_POST['colour'] == 'blue'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'blue' AND gender='kids'";
     }elseif($_POST['colour'] == 'green'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'green' AND gender='kids'";
     }elseif($_POST['colour'] == 'mix'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'mix' AND gender='kids'";
     }elseif($_POST['colour'] == 'grey'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'grey' AND gender='kids'";
     }elseif($_POST['colour'] == 'purple'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'purple' AND gender='kids'";
     }elseif($_POST['colour'] == 'yellow'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'yellow' AND gender='kids'";
     }elseif($_POST['colour'] == 'red'){
         //Run query
         $q = "SELECT * FROM shop WHERE COLOUR = 'red' AND gender='kids'";
     }
 }
 elseif(isset($_POST['item_type'])){
     if($_POST['item_type'] == 'shoe'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='shoe' AND gender='kids'";
     }elseif($_POST['item_type'] == 'shorts'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='shorts' AND gender='kids'";
     }elseif($_POST['item_type'] == 'tee'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='tee' AND gender='kids'";
     }elseif($_POST['item_type'] == 'jacket'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='jacket' AND gender='kids'";
     }elseif($_POST['item_type'] == 'windbreaker'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='windbreaker' AND gender='kids'";
     }elseif($_POST['item_type'] == 'tanktop'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='tanktop' AND gender='kids'";
     }elseif($_POST['item_type'] == 'skirt'){
         //Run query
         $q = "SELECT * FROM shop WHERE item_type='skirt' AND gender='kids'";
     }else{
         $query = "SELECT * FROM shop WHERE gender='kids'";
     }
 }
 elseif(isset($_POST['price'])){
     if($_POST['price'] == 'mintomax'){
         //Run query
         $q = "SELECT * FROM shop WHERE gender='kids' ORDER BY item_price ASC";
     }elseif($_POST['price'] == 'maxtomin'){
         //Run query
         $q = "SELECT * FROM shop WHERE gender='kids' ORDER BY item_price DESC";
     }
 }
 $r = mysqli_query( $dbc, $q ) ;
